...
def tensor_map(
    ...
    * When `out` and `in` are stride-aligned, avoid indexing
    ...
    def _map(
        ...
        shapes_match = len(out_shape) == len(in_shape) and np.all(out_shape == in_shape)
    ...
    return njit(_map, parallel=True, fastmath=True, cache=True)  # type: ignore
...
def tensor_zip(
    ...
    * When `out`, `a`, `b` are stride-aligned, avoid indexing
    ...
    return njit(_zip, parallel=True, fastmath=True, cache=True)  # type: ignore
